        ...
        try:
            ...
            for record in filtered_records:
                ...
                if record.transaction_record_service_item is None:
                    ...
                    flash(f'Stavka {record.id} nema validan id usluge (service_item_id={record.service_item_id}). Pogledati izvod {record.transaction_record_student_payment.statment_nubmer}.', 'danger')
                    return redirect(url_for('main.home'))
